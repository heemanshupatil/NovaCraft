  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.card}>
        ...
        <p className={styles.subtitle}>Sign in to your NovaCraft account.</p>
        ...
        <form onSubmit={handleSubmit} className={styles.form} noValidate>
          ...
          <div className={styles.field}>
            ...
            <div className={styles.passWrap}>
              ...
              />
              <button type="button" className={styles.eyeBtn} onClick={() => setShow(s => !s)} aria-label="Toggle password">
          ...
          {error && (
            <div className={styles.errorBox}><AlertCircle size={15} /> {error}</div>
          )}

          <button id="login-submit" type="submit" className={`btn btn-primary ${styles.submitBtn}`} disabled={loading}>
            {loading ? <span className={styles.spinner} /> : <><LogIn size={17} /> Sign In</>}
          </button>
        </form>
